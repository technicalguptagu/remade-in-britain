        ...
        a.data(b, "flexslider", d), n = {
            init: function () {
                d.animating = !1, d.currentSlide = e.startAt, d.animatingTo = d.currentSlide, d.atEnd = 0 === d.currentSlide || d.currentSlide === d.last, d.containerSelector = e.selector.substr(0, e.selector.search(" ")), d.slides = a(e.selector, d), d.container = a(d.containerSelector, d), d.count = d.slides.length, d.syncExists = a(e.sync).length > 0, "slide" === e.animation && (e.animation = "swing"), d.prop = i ? "top" : "marginLeft", d.args = {}, d.manualPause = !1, d.transitions = !e.video && !l && e.useCSS && function () {
                    ...
                    a.preventDefault();
                    var g = 0 > b ? d.getTarget("next") : d.getTarget("prev");
            ...
            asNav: {
                setup: function () {
					d.asNav = !0, d.animatingTo = Math.floor(d.currentSlide / d.move), d.currentItem = d.currentSlide, d.slides.removeClass(f + "active-slide").eq(d.currentItem).addClass(f + "active-slide"), d.slides.click(function (b) {
                        ...
                        var c = a(this),
                            f = c.index();
                        a(e.asNavFor).data("flexslider").animating || c.hasClass("active") || (d.direction = f > d.currentItem ? "next" : "prev", d.flexAnimate(f, e.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function () {
                    ...
                    if (d.controlNavScaffold = a('<ol class="' + f + "control-nav " + f + b + '"></ol>'), d.pagingCount > 1)
                        for (var j = 0; d.pagingCount > j; j++) i = "thumbnails" === e.controlNav ? '<img src="' + d.slides.eq(j).attr("data-thumb") + '"/>' : "<a>" + c + "</a>", d.controlNavScaffold.append("<li>" + i + "</li>"), c++;
                ...
                active: function () {
                    d.controlNav.removeClass(f + "active").eq(d.animatingTo).addClass(f + "active");
						for(var i=0;i<=d.last;i++){
							if(d.animatingTo==i){
								jQuery("#count"+d.animatingTo).addClass('active');
							}
							else
							{
                                 jQuery("#count"+i).removeClass();
							}
            ...
            touch: function () {
                ...
                function p(b) {
                    h = i ? a - b.touches[0].pageY : a - b.touches[0].pageX, n = i ? Math.abs(h) < Math.abs(b.touches[0].pageX - c) : Math.abs(h) < Math.abs(b.touches[0].pageY - c), (!n || Number(new Date) - m > 500) && (b.preventDefault(), !l && d.transitions && (e.animationLoop || (h /= 0 === d.currentSlide && 0 > h || d.currentSlide === d.last && h > 0 ? Math.abs(h) / g + 2 : 1), d.setProps(f + h, "setTouch")))
                }
                ...
                function q() {
                    if (b.removeEventListener("touchmove", p, !1), d.animatingTo === d.currentSlide && !n && null !== h) {
                        ...
                        d.canAdvance(o) && (550 > Number(new Date) - m && Math.abs(k) > 50 || Math.abs(k) > g / 2) ? d.flexAnimate(o, e.pauseOnAction) : l || d.flexAnimate(d.currentSlide, e.pauseOnAction, !0)
                    }
            ...
            if (m && 1 === d.pagingCount && (d.direction = b > d.currentItem ? "next" : "prev"), !d.animating && (d.canAdvance(b, p) || h) && d.is(":visible")) {
                if (m && o) {
                    var q = a(e.asNavFor).data("flexslider");
                    if (d.atEnd = 0 === b || b === d.count - 1, q.flexAnimate(b, !0, !1, !0, p), d.direction = b > d.currentItem ? "next" : "prev", q.direction = d.direction, Math.ceil((b + 1) / d.visible) - 1 === d.currentSlide || 0 === b) return d.currentItem = b, d.slides.removeClass(f + "active-slide").eq(b).addClass(f + "active-slide"), !1;
