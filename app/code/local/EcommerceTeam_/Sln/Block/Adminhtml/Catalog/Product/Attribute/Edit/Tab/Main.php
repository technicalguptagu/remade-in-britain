...
class EcommerceTeam_Sln_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Main
{
    ...
    protected function _prepareForm()
    {
	 ...
	 $fieldset->addField('top_category', 'select', array(
            'name'  => 'top_category',
            'label' => Mage::helper('catalog')->__('For Top Category'),
            'title' => Mage::helper('catalog')->__('For Top Category'),
            'values'=> array(
                EcommerceTeam_Sln_Block_Layer_View::NAVIGATION_TOP_CATEGORY_YES    => $this->__('Yes'),
                EcommerceTeam_Sln_Block_Layer_View::NAVIGATION_TOP_CATEGORY_NO        => $this->__('No'),
            ),
        ));
