...
class Apptha_Marketplace_Adminhtml_OrderController extends Mage_Adminhtml_Controller_action
{
    ...
    if ( $id > 0) {
      try {
        ...
        {
            $Data = array('commission_id' => $id, 'seller_id' => $seller_id,'seller_commission' => $seller_commission, 'admin_commission' => $admin_commission, 'order_id' =>$order_id,'received_status'=>0);
