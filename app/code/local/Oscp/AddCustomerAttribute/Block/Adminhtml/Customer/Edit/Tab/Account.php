...
class Oscp_AddCustomerAttribute_Block_Adminhtml_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
...
//        }
	...
	/* OSCDEV #42 Add custom fields to customer account information 2014/06/13*/
		$fieldset->addField('store_trading_name', 'text', array(
				'name'      => 'store_trading_name',
				'label' => Mage::helper('customer')->__('Store/Trading Name')				
				));
		$fieldset->addField('seller_existing_website', 'text', array(
				'name'      => 'seller_existing_website',
				'label' => Mage::helper('customer')->__('Seller Existing Website')				
				));
		$fieldset->addField('seller_example_image', 'text', array(
				'name'      => 'seller_example_image',
				'label' => Mage::helper('customer')->__('Seller Example Image')				
				));
		$fieldset->addField('seller_additional_info', 'text', array(
				'name'      => 'seller_additional_info',
				'label' => Mage::helper('customer')->__('Seller Additional Info')				
				));
	/* EOF OSCDEV #42  */
