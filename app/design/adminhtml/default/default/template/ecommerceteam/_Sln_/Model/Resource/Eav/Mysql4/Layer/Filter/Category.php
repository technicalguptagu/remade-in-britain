    ...
    extends Mage_Catalog_Model_Resource_Eav_Mysql4_Layer_Filter_Attribute
{
    ...
    {
        //modified by developer 01-Nov-12
		$filterSingleton = FiltercatSingleton::catsingleton();
...
//BOf developer4 01-Nov-12
class FiltercatSingleton {
    ...
    static public function catsingleton() {
