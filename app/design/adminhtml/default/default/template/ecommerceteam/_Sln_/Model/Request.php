 ...
 * @version      3.0
 */
class EcommerceTeam_Sln_Model_Request extends Mage_Core_Model_Abstract {
    ...
    protected function _initAliases() {
        ...
        $aliasCollection->getSelect()->join(
                array('attribute' => $aliasCollection->getTable('eav/attribute')), 'main_table.attribute_id=attribute.attribute_id', 'attribute_code');
